...
🏗️ Tech StackFrontend: React.js, React Router, Axios, Bootstrap 5.Backend: Node.js, Express.js.Database: MySQL with Sequelize ORM.AI/Voice: OpenAI API, Web Speech API (react-speech-recognition).🛠️ Installation & Setup1. Clone the repositoryBashgit clone https://github.com/anujdhumal11/invoice-app.git
